...
export async function findPriceChartingYuGiOhMatch(args: {
  ...
  return {
    ...
    rarity: match.rarity,
    currentPriceRaw: match.currentPriceRaw,
    currentPricePsa9: match.currentPricePsa9,
    currentPricePsa10: match.currentPricePsa10,
    suggestedPrice: match.suggestedPrice,
    priceChartingUrl: match.priceChartingUrl,
