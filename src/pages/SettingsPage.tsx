      ...
      <Card className="bg-card border-border">
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold">Camera Features</h3>

              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label className="text-sm font-medium">Auto-focus</Label>
                  <p className="text-xs text-muted-foreground">Enable camera auto-focus on capture</p>
                </div>
                <Switch
                  checked={scannerSettings.featureAutoFocus}
                  onCheckedChange={(checked) => updateScannerSettings({ featureAutoFocus: checked })}
                />
              </div>

              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label className="text-sm font-medium">Continuous auto-focus</Label>
                  <p className="text-xs text-muted-foreground">Keep focus continuously updating</p>
                </div>
                <Switch
                  checked={scannerSettings.featureContinuousAutoFocus}
                  onCheckedChange={(checked) => updateScannerSettings({ featureContinuousAutoFocus: checked })}
                />
              </div>

              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label className="text-sm font-medium">Tap-to-focus</Label>
                  <p className="text-xs text-muted-foreground">Tap on video to focus at that point</p>
                </div>
                <Switch
                  checked={scannerSettings.featureTapToFocus}
                  onCheckedChange={(checked) => updateScannerSettings({ featureTapToFocus: checked })}
                />
              </div>
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  ...
                  <p className="text-xs text-muted-foreground">Show zoom slider and buttons</p>
                </div>
                <Switch
                  checked={scannerSettings.featureZoomControls}
                  onCheckedChange={(checked) => updateScannerSettings({ featureZoomControls: checked })}
                />
              </div>

              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label className="text-sm font-medium">Digital zoom fallback</Label>
                  <p className="text-xs text-muted-foreground">Use CSS scaling when hardware zoom unavailable</p>
                </div>
                <Switch
                  checked={scannerSettings.featureDigitalZoomFallback}
                  onCheckedChange={(checked) => updateScannerSettings({ featureDigitalZoomFallback: checked })}
                />
              </div>

              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label className="text-sm font-medium">Pinch-to-zoom</Label>
                  <p className="text-xs text-muted-foreground">Use two fingers to zoom on mobile</p>
                </div>
                <Switch
                  checked={scannerSettings.featurePinchToZoom}
                  onCheckedChange={(checked) => updateScannerSettings({ featurePinchToZoom: checked })}
                />
              </div>

              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label className="text-sm font-medium">Torch/flash control</Label>
                  <p className="text-xs text-muted-foreground">Enable flashlight toggle button</p>
                </div>
                <Switch
                  checked={scannerSettings.featureTorchControl}
                  onCheckedChange={(checked) => updateScannerSettings({ featureTorchControl: checked })}
                />
              </div>
            </div>
            ...
            <div className="space-y-4">
              <h3 className="text-sm font-semibold">Capture Enhancements</h3>

              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label className="text-sm font-medium">Anti-glare filter</Label>
                  <p className="text-xs text-muted-foreground">Reduce glare hotspots in captured images</p>
                </div>
                <Switch
                  checked={scannerSettings.featureAntiGlare}
                  onCheckedChange={(checked) => updateScannerSettings({ featureAntiGlare: checked })}
                />
              </div>

              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label className="text-sm font-medium">OCR enhancement</Label>
                  <p className="text-xs text-muted-foreground">Apply contrast boost for better text recognition</p>
                </div>
                <Switch
                  checked={scannerSettings.featureOCREnhancement}
                  onCheckedChange={(checked) => updateScannerSettings({ featureOCREnhancement: checked })}
                />
              </div>

              <div className="flex items-center justify-between">
                <div className="space-y-0.5">
                  <Label className="text-sm font-medium">High-resolution capture</Label>
                  <p className="text-xs text-muted-foreground">Capture at maximum camera resolution</p>
                </div>
                <Switch
                  checked={scannerSettings.featureHighResCapture}
                  onCheckedChange={(checked) => updateScannerSettings({ featureHighResCapture: checked })}
                />
              </div>
            </div>
          </div>
